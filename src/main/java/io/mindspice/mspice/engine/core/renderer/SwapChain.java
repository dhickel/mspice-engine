...
public class SwapChain {
    ...
    public SwapChain(Device device, Surface surface, Window window, int requestedImages, boolean vsync,
        ...
        System.out.println("Creating Vulkan SwapChain");
        this.device = device;
    ...
    private int calcNumImages(VkSurfaceCapabilitiesKHR surfCapabilities, int requestedImages) {
        ...
        System.out.printf("Requested [%d] images, got [%d] images. Surface capabilities, maxImages: [%d], minImages [%d]\n",
    ...
    public void cleanup() {
        System.out.println("Destroying Vulkan SwapChain");
